...
where MRN in ('urn:mrn:kr:vessel:neonexsoft:sc3', 'urn:mrn:kr:service:instance:neonexsoft:sp3');
...
union all
select 'urn:mrn:kr:service:instance:neonexsoft:sp3','192.168.81.57','9093','2';
