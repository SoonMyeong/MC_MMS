...
public class Mms2SC1pollSP002 {
	public static void main(String args[]) throws Exception{
		String myMRN = "urn:mrn:kr:vessel:neonexsoft:sc2";
		

		MMSConfiguration.MMS_URL = "192.168.81.43:8088";
		...
		//===== active certificate =====
		String privateKeyPath_active = "./pem/PrivateKey_sc2.pem";
		String certPath_active      = "./pem/Certificate_sc2.pem";
