...
public class Mms3SC3pollSP002 {
	public static void main(String args[]) throws Exception{
		String myMRN = "urn:mrn:kr:vessel:neonexsoft:sc3";
		

		//MMSConfiguration.MMS_URL = "192.168.81.83:8088";
		...
		///0:long polling???
		String dstMRN = "urn:mrn:kr:device:neonexsoft:mms3";
		String svcMRN = "urn:mrn:kr:service:instance:neonexsoft:sp2";
		...
		//===== active certificate =====
		String privateKeyPath_active = "./pem/PrivateKey_sc3.pem";
		String certPath_active      = "./pem/Certificate_sc3.pem";
