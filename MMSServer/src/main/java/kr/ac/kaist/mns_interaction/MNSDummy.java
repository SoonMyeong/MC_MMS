...
public class MNSDummy {
	...
	public static void main(String argv[]) throws Exception
	{
		...
		//       -------------Put MRN --> IP Information -------------MMS Client is disconnected.
		...
		//MRNtoIP.put("EncZoneRes","127.0.0.1:8902:2");
		//MRNtoIP.put("urn:mrn:smart:service:instance:mof:S40","127.0.0.1:8902:2");
...
//		MRNtoIP.put("urn:mrn:smart:vessel:imo-no:mof:tmp520fors55","203.250.182.203:0:1");
		...
		// LOCAL TEST //
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-01-client","172.18.0.5:0:1");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-01-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-02-client","172.18.0.5:0:1");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-02-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-03-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-04-client","172.18.0.5:0:1");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-04-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-06-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-07-client","1.1.1.1:0:1");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-07-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-08-client","172.18.0.5:8907:1");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-08-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-09-client","172.18.0.5:8907:1");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-09-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-10-client","1.1.1.1:0:1");
		MRNtoIP.put("urn:mrn:imo:imo-no:ts-mms-10-server","172.18.0.4:8907:2");
		MRNtoIP.put("urn:mrn:smart-navi:device:service-provider","172.18.0.4:0:2");
		//-----------------------------------------------------
...
*/
	...
	public static class ConnectionToClient {
		...
		public ConnectionToClient(Socket connectionSocket) {
